...
export default {
    ...
    data () {
        return {
        	listurl: '/test/TS001L.do', 
        	saveurl: '/test/TS001I.do',
        	deleteurl: '/test/TS001D.do',
        	updateurl: '/test/TS001U.do',
        	testKey:'',
        	testOne:'',
        	testTwo:'',
        	viewModal:false,
    ...
    methods: {
        ...
        cancing(selection, row){
        	...
        	if(this.selectedLines>0){
        		this.deleteKey.splice(this.deleteKey.indexOf(row.testKey), 1);
        	}
        },
